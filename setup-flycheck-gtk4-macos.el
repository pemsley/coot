...
(setq build-path-list
  (list
   ...
   "/opt/homebrew/Cellar/python@3.13/3.13.2/Frameworks/Python.framework/Versions/3.13/include/python3.13"
   "/opt/homebrew/Cellar/glm/1.0.1/include"
   "/opt/homebrew/Cellar/gtk4/4.18.2/include/gtk-4.0"
   "/opt/homebrew/Cellar/glib/2.84.0/include/glib-2.0"
   "/opt/homebrew/Cellar/glib/2.84.0/lib/glib-2.0/include"
   "/opt/homebrew/Cellar/cairo/1.18.4/include/cairo"
   "/opt/homebrew/Cellar/pango/1.56.3/include/pango-1.0"
   "/opt/homebrew/Cellar//harfbuzz/11.0.0/include/harfbuzz"
