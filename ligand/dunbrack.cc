...
// 
CResidue *
coot::dunbrack::GetResidue(int i_rot) const {
...
coot::dunbrack::rotamers(const std::string &res_type, float prob_cut) const {
...
float
coot::dunbrack::Chi1(int irot) const {
...
// 
std::vector<CAtom *>
coot::dunbrack::ordered_residue_atoms(CResidue *residue_p) const {
...
coot::dunbrack::probability_of_this_rotamer() {
...
std::pair<short int, double>
coot::dunbrack::probability_of_this_rotamer(const std::vector<double> &chi_angle_values,
...
coot::dunbrack::rotamer_atom_names_to_indices(const std::vector<std::vector<std::string> > &residue_rotamer_atoms,
					      PCAtom *residue_atoms,
...
// return in degrees
double
coot::dunbrack::chi_torsion(const std::vector<int> &chi_angle_atoms_indices,
			    PCAtom *residue_atoms) {
...
coot::dunbrack::rotamer_atoms(const std::string &residue_name) const {
...
// 
int 
coot::dunbrack::optimize_rotamer_by_atom_names() {
