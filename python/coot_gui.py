	...
	def file_func1(*args):
		...
		fc_window = gtk.FileChooserDialog("file selection",
                ...
                if response == gtk.RESPONSE_OK:
                   ...
                   fc_window.destroy
#		fc_window.ok_button.connect("clicked", file_ok_sel)
#		fc_window.cancel_button.connect("clicked",
#				lambda w: fc_window.destroy())
#		fc_window.show()
...
def cootaneer_gui(imol):
	...
	def entry_text_pair_frame(seq_info):
		...
		vbox.pack_start(text_box, False, False, 2)
