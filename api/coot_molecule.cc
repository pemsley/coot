...
coot::simple_mesh_t
coot::molecule_t::get_molecular_representation_mesh(const std::string &cid,
                                                    const std::string &colour_scheme,
                                                    const std::string &style) const {

   std::cout << "::::::::::::::::::::::::: HERE A " << colour_scheme << std::endl;
         ...
         if (displayPrimitive.type() == DisplayPrimitive::PrimitiveType::SurfacePrimitive    ||
            ...
            if (true)
               std::cout << "in molecular_representation_instance_to_mesh(): Here B adding "
                         << submesh.vertices.size() << " vertices and " << submesh.triangles.size() << " triangles" << std::endl;
   ...
   // auto chain_cs = ColorScheme::colorChainsScheme();n
   // auto ele_cs   = ColorScheme::colorByElementScheme();
   auto this_cs = ColorScheme::colorChainsScheme();
   std::string atom_selection_str = cid;
   ...
   auto submesh = molecular_representation_instance_to_mesh(molrepinst);
   mesh.add_submesh(submesh);
