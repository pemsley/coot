...
NB_MODULE(chapi, m) {
    ...
    .def("accept_rotamer_probability_tables_compressed_data",&molecules_container_t::accept_rotamer_probability_tables_compressed_data)
    ...
    .def("add_compound",&molecules_container_t::add_compound)
    .def("add_hydrogen_atoms",&molecules_container_t::add_hydrogen_atoms)
    .def("add_parallel_plane_restraint",&molecules_container_t::add_parallel_plane_restraint)
    ...
    .def("add_terminal_residue_directly_using_bucca_ml_growing",&molecules_container_t::add_terminal_residue_directly_using_bucca_ml_growing)
    .def("add_terminal_residue_directly_using_bucca_ml_growing_using_cid",&molecules_container_t::add_terminal_residue_directly_using_bucca_ml_growing_using_cid)
    ...
    .def("atom_cid_to_atom_spec",&molecules_container_t::atom_cid_to_atom_spec)
    ...
    .def("change_chain_id",&molecules_container_t::change_chain_id)
    ...
    .def("clear_refinement",&molecules_container_t::clear_refinement)
    .def("clear_target_position_restraint",&molecules_container_t::clear_target_position_restraint)
    .def("clear_target_position_restraints",&molecules_container_t::clear_target_position_restraints)
    ...
    .def("debug",&molecules_container_t::debug)
    ...
    .def("delete_literal_using_cid",&molecules_container_t::delete_literal_using_cid)
    ...
    .def("delete_side_chain_using_cid",&molecules_container_t::delete_side_chain_using_cid)
    ...
    .def("display_molecule_names_table",&molecules_container_t::display_molecule_names_table)
    .def("eigen_flip_ligand", nb::overload_cast<int, const std::string&>                        (&molecules_container_t::eigen_flip_ligand_using_cid))
    .def("eigen_flip_ligand",&molecules_container_t::eigen_flip_ligand)
    ...
    .def("fill_partial_residue_using_cid",&molecules_container_t::fill_partial_residue_using_cid)
    ...
    .def("fit_ligand_multi_ligand",&molecules_container_t::fit_ligand_multi_ligand)
    ...
    .def("fit_to_map_by_random_jiggle_using_cid",&molecules_container_t::fit_to_map_by_random_jiggle_using_cid)
    .def("fit_to_map_by_random_jiggle_with_blur_using_cid",&molecules_container_t::fit_to_map_by_random_jiggle_with_blur_using_cid)
    .def("fix_atom_selection_during_refinement",&molecules_container_t::fix_atom_selection_during_refinement)
    ...
    .def("get_atom",&molecules_container_t::get_atom)
    .def("get_atom",&molecules_container_t::get_atom, nb::rv_policy::reference)
    .def("get_atom_position",&molecules_container_t::get_atom_position)
    .def("get_atom_using_cid",&molecules_container_t::get_atom_using_cid)
    .def("fill_rotamer_probability_tables",&molecules_container_t::fill_rotamer_probability_tables)
    .def("copy_fragment_using_residue_range",&molecules_container_t::copy_fragment_using_residue_range)
    .def("copy_fragment_using_cid",&molecules_container_t::copy_fragment_using_cid)
    .def("close_molecule",&molecules_container_t::close_molecule)
    ...
    .def("get_chemical_features_mesh",&molecules_container_t::get_chemical_features_mesh)
    .def("get_cif_file_name",&molecules_container_t::get_cif_file_name)
    .def("get_cif_restraints_as_string",&molecules_container_t::get_cif_restraints_as_string)
    .def("get_colour_rules",&molecules_container_t::get_colour_rules)
    .def("get_colour_table",&molecules_container_t::get_colour_table)
    .def("get_colour_table_for_blender", &molecules_container_t::get_colour_table_for_blender)
    .def("get_data_set_file_name",&molecules_container_t::get_data_set_file_name)
    .def("get_density_at_position", &molecules_container_t::get_density_at_position)
    .def("get_diff_diff_map_peaks",&molecules_container_t::get_diff_diff_map_peaks)
    .def("get_eigenvalues",&molecules_container_t::get_eigenvalues)
    .def("get_extra_restraints_mesh",&molecules_container_t::get_extra_restraints_mesh)
    ...
    .def("get_mesh_for_ligand_validation_vs_dictionary",&molecules_container_t::get_mesh_for_ligand_validation_vs_dictionary)
    ...
    .def("get_molecule_diameter",&molecules_container_t::get_molecule_diameter)
    ...
    .def("get_ncs_related_chains",&molecules_container_t::get_ncs_related_chains)
    ...
    .def("get_residue",&molecules_container_t::get_residue)
    ...
    .def("get_simple_molecule",&molecules_container_t::get_simple_molecule)
    .def("get_single_letter_codes_for_chain",&molecules_container_t::get_single_letter_codes_for_chain)
    .def("get_suggested_initial_contour_level",&molecules_container_t::get_suggested_initial_contour_level)
    ...
    .def("init_refinement_of_molecule_as_fragment_based_on_reference",&molecules_container_t::init_refinement_of_molecule_as_fragment_based_on_reference)
    .def("install_model",&molecules_container_t::install_model)
    .def("is_EM_map",&molecules_container_t::is_EM_map)
    ...
    .def("mmrrcc_internal",&molecules_container_t::mmrrcc_internal)
    .def("molecule_to_PDB_string",&molecules_container_t::molecule_to_PDB_string)
    .def("molecule_to_mmCIF_string",&molecules_container_t::molecule_to_mmCIF_string)
    ...
    .def("ramachandran_analysis_for_chain",&molecules_container_t::ramachandran_analysis_for_chain)
    ...
    .def("read_standard_residues",&molecules_container_t::read_standard_residues)
    .def("redo",&molecules_container_t::redo)
    .def("refine",&molecules_container_t::refine)
    .def("refine_direct",&molecules_container_t::refine_direct)
    .def("refine_residue_range",&molecules_container_t::refine_residue_range)
    ...
    .def("residue_cid_to_residue_spec",&molecules_container_t::residue_cid_to_residue_spec)
    ...
    .def("set_base_colour_for_bonds",&molecules_container_t::set_base_colour_for_bonds)
    .def("set_bespoke_carbon_atom_colour",&molecules_container_t::set_bespoke_carbon_atom_colour)
    ...
    .def("set_map_colour",&molecules_container_t::set_map_colour)
    .def("set_map_colour_saturation",&molecules_container_t::set_map_colour_saturation)
    .def("set_map_is_contoured_with_thread_pool",&molecules_container_t::set_map_is_contoured_with_thread_pool)
    ...
    .def("set_max_number_of_threads_in_thread_pool",&molecules_container_t::set_max_number_of_threads_in_thread_pool)
    ...
    .def("set_use_bespoke_carbon_atom_colour",&molecules_container_t::set_use_bespoke_carbon_atom_colour)
    ...
    .def("test_the_threading",&molecules_container_t::test_the_threading)
    .def("test_thread_pool_threads",&molecules_container_t::test_thread_pool_threads)
    .def("testing_start_long_term_job",&molecules_container_t::testing_start_long_term_job)
    .def("testing_stop_long_term_job",&molecules_container_t::testing_stop_long_term_job)
    .def("turn_off_when_close_target_position_restraint",&molecules_container_t::turn_off_when_close_target_position_restraint)
    .def("undo",&molecules_container_t::undo)
    .def("unmodelled_blobs",&molecules_container_t::unmodelled_blobs)
    .def("valid_labels",&molecules_container_t::valid_labels)
