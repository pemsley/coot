...
NB_MODULE(chapi, m) {
    ...
    .def("set_add_waters_water_to_protein_distace_lim_min",&molecules_container_t::set_add_waters_water_to_protein_distace_lim_min)
    .def("set_add_waters_water_to_protein_distace_lim_max",&molecules_container_t::set_add_waters_water_to_protein_distace_lim_max)
