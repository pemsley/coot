...
# else
    ...
    .def(nb::init<>())
    .def_prop_rw("seqNum",[](mmdb::Residue &t) { return t.GetSeqNum() ; },[](mmdb::Residue &t, int value) { t.GetSeqNum() = value; })
    ...
    .def_prop_rw("index",[](mmdb::Residue &t) { return t.GetIndex() ; },[](mmdb::Residue &t, int value) { t.GetIndex() = value; })
