/*
 * MoleculesToTriangles/CXXClasses/SolidColorRule-statics-gemmi.cc
 *
 * gemmi-only build helper: provides the two mmdb-free static members of the
 * original SolidColorRule (the named-colour table and the hex parser) without
 * compiling SolidColorRule.cpp, which drags in the mmdb-based CompoundSelection.
 * The definitions are extracted verbatim from SolidColorRule.cpp.
 *
