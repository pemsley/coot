...
You can calcuate the map skeleton in Coot directly:
...
Modelling Tools dialog\footnote{this is quite advanced)}.
  ...
  If you want to do this, I suggest you use Go To Atom and start
  residue 2 A (this allows you to build the complete A chain in the
  correct direction (it takes about 15 minutes) and you can compare it
  to the real structure afterwards.
