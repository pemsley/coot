...
namespace coot {
   ...
   class gaussian_surface_t {
      ...
      void using_an_xmap(mmdb::Manager *mol, const std::string &cid,
   ...
   public:
      // The selection string is a coot/mmdb CID (e.g. "//A" or "//A/10-20"); a bare
      // token (e.g. "A") is treated as a chain-id for backwards compatibility.
      explicit gaussian_surface_t(mmdb::Manager *mol, const std::string &cid,
