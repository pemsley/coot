...
void init_shaders() {
   ...
   if (err == GL_INVALID_VALUE)
      std::cout << "ERROR:: programID " << programID
                << " is not a value generated by OpenGL" << std::endl;
   glBindAttribLocation(programID, 2, "colour");
   err = glGetError();
   std::cout << "init_shaders() glBindAttribLocation() colour err is " << err << std::endl;
   if (err == GL_INVALID_VALUE)
      std::cout << "ERROR:: programID " << programID
                << " is not a value generated by OpenGL" << std::endl;
   ...
   graphics_info_t::view_rotation_location = glGetUniformLocation(programID, "view_rotation");
