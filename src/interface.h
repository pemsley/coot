...
GtkWidget* create_coords_fileselection1 (void);
GtkWidget* create_dataset_fileselection1 (void);
...
GtkWidget* create_map_name_fileselection1 (void);
GtkWidget* create_phs_info_box (void);
GtkWidget* create_phs_coordinates_fileselection (void);
...
GtkWidget* create_save_coords_fileselection1 (void);
...
GtkWidget* create_cif_dictionary_fileselection (void);
...
GtkWidget* create_save_symmetry_coords_fileselection (void);
...
GtkWidget* create_save_state_fileselection (void);
...
GtkWidget* create_baton_build_paras_dialog (void);
