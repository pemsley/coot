...
void fle_view_internal_to_png(int imol, const char *chain_id, int res_no, 
   ...
   atom_selection_container_t flat = get_atom_selection(prodrg_output_flat_pdb_file_name, "", false, true, false, false);
...
coot::flev_attached_hydrogens_t::cannonballs(mmdb::Residue *ligand_residue_3d,
   ...
   atom_selection_container_t asc = get_atom_selection(prodrg_3d_ligand_file_name, "", false, true, false, false);
   if (asc.read_success) {
