...
void on_single_map_properties_colour_button_clicked_gtkbuilder_callback(GtkButton *button, gpointer user_data);
...
void on_single_map_properties_ok_button_clicked_gtkbuilder_callback(GtkButton *button, gpointer user_data);
