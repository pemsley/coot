...
int CXXFortranFile::getFortranData(char *buffer, const int itemSize, const int nItems, const int fortranDataType)
{

  

  int recordSize;
  int nBytesToRead, nToReadNow, padding;
...
int CXXFortranFile::putFortranData(char *buffer, const int itemSize, const int nItems, const int fortranDataType)
{
  int recordSize;
  int nBytesToWrite, padding;
