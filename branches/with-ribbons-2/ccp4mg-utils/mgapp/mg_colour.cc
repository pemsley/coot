...
//----------------------------------------------------------------------
  //std::cout << "CMolColour::SetOneColour\n";
  oneColour = icol;
  if_continuous = 0;
...
//-------------------------------------------------------------------------
  ...
  //std::cout << "SetScheme n_rules " << n_rules << std::endl;
...
//----------------------------------------------------------------------
  ...
  atom_colour_vector = AtomColourVector();
  //std::cout << "CMolColour::ReColour( )\n";
  switch ( mode ) {
  case ONECOLOUR:
    RC = OneColour();
    break;
...
//-----------------------------------------------------------------------------
  ...
  RC = GetSelection (selAtoms, nat);
  colour = new int[nat];
  //std::cout << "CMolColour::UserScheme nat " << nat << std::endl;
...
//----------------------------------------------------------------------
  ...
  RC = SecStr->SetSchemeInt ( 7, secstrcods,secstrcol );
