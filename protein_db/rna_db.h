...
/*!
  Class for storing compact RNA chain information for use
  with RNA500 DB. The same class is used for storing residues in the
...
class Residue {
 public:
  ...
  //! Constructor: from P coord and residue type
  Residue( clipper::Coord_orth& p, const clipper::String& type );
  //! Constructor: from main chain coords and residue type
  Residue( clipper::Coord_orth& p, 
	   clipper::Coord_orth& o1p, 
	   clipper::Coord_orth& o2p, 
	   clipper::Coord_orth& o5pr, 
	   clipper::Coord_orth& c5pr, 
	   clipper::Coord_orth& c4pr, 
	   clipper::Coord_orth& o4pr, 
	   clipper::Coord_orth& c3pr, 
	   clipper::Coord_orth& o3pr, 
	   clipper::Coord_orth& c2pr, 
	   clipper::Coord_orth& o2pr, 
	   clipper::Coord_orth& c1pr, 
	   const clipper::String& type );
  //! Constructor: from MMonomer
  Residue( const clipper::MMonomer& mm );
  clipper::Coord_orth coord_P() const; 
  clipper::Coord_orth coord_O1P() const; 
  clipper::Coord_orth coord_O2P() const; 
  clipper::Coord_orth coord_O5_prime() const; 
  clipper::Coord_orth coord_C5_prime() const; 
  clipper::Coord_orth coord_C4_prime() const; 
  clipper::Coord_orth coord_O4_prime() const; 
  clipper::Coord_orth coord_C3_prime() const; 
  clipper::Coord_orth coord_O3_prime() const; 
  clipper::Coord_orth coord_C2_prime() const; 
  clipper::Coord_orth coord_O2_prime() const; 
  clipper::Coord_orth coord_C1_prime() const; 
