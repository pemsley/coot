...
namespace coot {
   ...
   namespace minimol {
      ...
      public:
         ...
         // residue(mmdb::Residue *residue_p, const std::vector<std::string> &keep_only_these_atoms);
         // residue(){ seqnum = mmdb::MinInt4; /* unset */ }; // for resizing the residues in fragment
         explicit residue(gemmi::Residue *residue_p);
         residue(gemmi::Residue *residue_p, const std::vector<std::string> &keep_only_these_atoms);
         ...
         gemmi::Residue *make_residue() const; // caller disposes of memory
         void update_positions_from(gemmi::Residue *residue_p);
      };
      ...
      class molecule {
         ...
         short int setup(gemmi::Structure *mol_in, bool udd_atom_index_to_user_data_flag);
         short int have_spacegroup;
         short int have_cell;
         // std::pair<bool, int> min_resno_in_chain(mmdb::Chain *chain_p) const;
         std::pair<bool, int> min_resno_in_chain(gemmi::Chain *chain_p) const;
      public:
         ...
         explicit molecule(gemmi::Structure *mol_in, bool udd_atom_index_to_user_data=false);
         ...
         // molecule(mmdb::PPAtom atom_selection, int n_residues_atoms, const std::vector<mmdb::Atom> &atoms);


         short int init(gemmi::Structure *mol_in) {return setup(mol_in, false);}
