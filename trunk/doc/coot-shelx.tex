...
\item {\bf Most other} pre-coordinate SHELXL instructions are not
  ...
  %% I found that button a bit dull, so took the liberty and made a
  %% chooser-entry thingy for this in the shelx-extensions -- much
  %% more useful, isn't it?  Do I need to say anything about the
  %% reshelx process?
