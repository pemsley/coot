...
//Displayobject *Ribbons = 0;
void
show_ribbons(int imol) {

//  InitMatType();
//  CMMANManager* molHnd=0;
//  CMGSBase *s_base = new CMGSBase("/usr/programs/ccp4mg-1.1beta4/data/monomer_library/",
//				  "/usr/programs/ccp4mg-1.1beta4/data/monomer_library",
//				  "",
//				  "/usr/programs/ccp4mg-1.1beta4/data/ener_lib.cif",
//				  "/usr/programs/ccp4mg-1.1beta4/data/mon_lib_list",
//				  "/usr/programs/ccp4mg-1.1beta4/data/elements.cif");

 // CMolBondParams *bond_params = new CMolBondParams(s_base);

//    molHnd = new CMMANManager(s_base, bond_params);

  //  std::cout <<"BL DEBUG:: reading in file " << graphics_info_t::molecules[imol].name_ <<std::endl;
//    molHnd->ReadCoorFile(graphics_info_t::molecules[imol].name_.c_str());
  
    //CMMANManager *molHnd = 0;
    //molHnd = (CMMANManager*)graphics_info_t::molecules[imol].atom_sel.mol;
...
//  std::cout << "BL DEBUG:: no of sel atoms :"<< nSelAtoms << "\n";
...
//     colours[i] = 0;
//  std::cout << "BL DEBUG:: no of splines :" << "\n";
  
//  cv->SetAtomColours(nSelAtoms,colours);
//  std::cout << "BL DEBUG:: no of splines :" << "\n";
//  SplineInfo sinfo = GetSplineInfo(molHnd,selHnd,cv,4,-1,-1,1,0,0);

//  std::cout << "BL DEBUG:: no of splines :" << sinfo.splines.size() << "\n";
//  if(sinfo.splines.size()>0) std::cout << "BL DEBUG:: first spline size: " << sinfo.splines[0].size() << "\n";
...
//
//  params.SetFloat("worm_width",0.2);
//  params.SetFloat("ribbon_width",2.5);
//  params.SetInt("ribbon_style",0);
//  params.SetFloat("worm_width",0.2);
//  params.SetFloat("arrow_width",2.2);
//  params.SetInt("helix_style",0);
//  params.SetInt("two_colour_ribbon",0);
//  params.SetFloat("alpha_helix_width",1.5);
//
//  int mode=SPLINE;
  graphics_info_t::molecules[imol].cootribbons = 1;
  graphics_info_t::molecules[imol].make_ribbons();
  graphics_draw();
//
//  build_spline(sinfo, Ribbons, mode, params, global_params, "", "");
//  graphics_info_t::molecules[imol].Ribbons = *Ribbons;
...
void
hide_ribbons(int imol) {

  graphics_info_t::molecules[imol].cootribbons = 0;
  graphics_draw();
