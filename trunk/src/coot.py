...
class str_mtime(_object):
    ...
    if _newclass:mtime = property(_coot.str_mtime_mtime_get, _coot.str_mtime_mtime_set)
    __swig_setmethods__["file"] = _coot.str_mtime_file_set
    __swig_getmethods__["file"] = _coot.str_mtime_file_get
    if _newclass:file = property(_coot.str_mtime_file_get, _coot.str_mtime_file_set)
...
class command_arg_t(_object):
    ...
    if _newclass:type = property(_coot.command_arg_t_type_get, _coot.command_arg_t_type_set)
    __swig_setmethods__["f"] = _coot.command_arg_t_f_set
    __swig_getmethods__["f"] = _coot.command_arg_t_f_get
    if _newclass:f = property(_coot.command_arg_t_f_get, _coot.command_arg_t_f_set)
    __swig_setmethods__["i"] = _coot.command_arg_t_i_set
    __swig_getmethods__["i"] = _coot.command_arg_t_i_get
    if _newclass:i = property(_coot.command_arg_t_i_get, _coot.command_arg_t_i_set)
    __swig_setmethods__["s"] = _coot.command_arg_t_s_set
    __swig_getmethods__["s"] = _coot.command_arg_t_s_get
    if _newclass:s = property(_coot.command_arg_t_s_get, _coot.command_arg_t_s_set)
