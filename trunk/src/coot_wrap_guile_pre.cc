...
#define SWIGTYPE_p_clipper__String swig_types[10]
#define SWIGTYPE_p_coot__alias_path_t swig_types[11]
#define SWIGTYPE_p_coot__atom_spec_t swig_types[12]
#define SWIGTYPE_p_coot__command_arg_t swig_types[13]
#define SWIGTYPE_p_coot__file_attribs_info_t swig_types[14]
...
#define FUNC_NAME "safe-scheme-command"
  ...
  safe_scheme_command((std::string const &)*arg1);
  gswig_result = SCM_UNSPECIFIED;
